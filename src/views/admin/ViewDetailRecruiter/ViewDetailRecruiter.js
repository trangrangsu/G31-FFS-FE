...
function ViewDetailRecruiter() {
    const recruiter =
    {
        ...
        description: 'Top CV mong muốn trở thành công ty cung cấp các giải pháp phần mềm và dịch vụ công nghệ thông tin toàn cầu, luôn luôn sáng tạo các giá trị vì khách hàng, đem lại cuộc sống hạnh phúc cho toàn thể các thành viên, đóng góp cho cộng đồng.Kết nối đúng người đúng việc là một bài toán rất khó ở Việt Nam, là thách thức của bất kỳ nền tảng tuyển dụng nào. Với năng lực lõi là công nghệ, đặc biệt là trí tuệ nhân tạo (AI), sứ mệnh của TopCV đặt ra cho mình là thay đổi thị trường tuyển dụng - nhân sự ngày một hiệu quả hơn.Mỗi ngày, chúng tôi kết nối hàng nghìn ứng viên tiềm năng với các doanh nghiệp phù hợp, đồng hành cùng hơn 110.000 doanh nghiệp tuyển dụng hiệu quả, từ các tập đoàn đa quốc gia đến các công ty khởi nghiệp trẻ',
        star: '5'
    };
    return (
                ...
                <div className={cx('recruiter-info')}>
                    <div className={cx('left-info')}>
                        <div className={cx('img-info')}>
                            <img className={cx('avatar-info')} src={recruiter.avatar} alt="Girl in a jacket" width="500" height="600" />
                        </div>
                        <div className={cx('left-detail')}>
                            ...
                            <div>Đánh giá: {recruiter.star} <FontAwesomeIcon icon={faStar} className={cx('icon-user')} /></div>
                        </div>
                    </div>
