    ...
    return (
        <div className={cx('wrapper')}>
            <div className={cx('container')}>
                <div className={cx('title-post')}><p className={cx('greeting-title')}>Đăng Tin Tuyển Dụng</p></div>
                <div className={cx('form-Post')}>
                    <div className={cx('career-post')}>
                        ...
                        <div className={cx('right-post')}>
                            ...
                            <select className={cx('form-select')} aria-label="Default select example">
                                <option selected><label className={cx('form-label')}>--Tên Lĩnh Vực--</label></option>
                            ...
                            <input type="text" className={cx('form-input')} placeholder='Ví dụ: Thiết kế website quản lí công ty' />
                        </div>
                    </div>
                    <div className={cx('post-detail')}>
                        ...
                        <div className={cx('right-post')}>
                            ...
                            <textarea className={cx('form-area')} rows="5" placeholder='Ví dụ:Cần thiết kế website có chức năng bán hàng, quản lí kho....'></textarea>
                            ...
                            <input type="date" className={cx('form-input', 'deadline')} placeholder='Ví dụ: Thiết kế website quản lí công ty' />
                        </div>
                    </div>
                    <div className={cx('more-req')}>
                        ...
                        <div className={cx('right-post')}>
                            ...
                            <select className={cx('form-select')} aria-label="Default select example">
                                <option selected><label className={cx('form-label')}>--Nơi cần thuê--</label></option>
                    ...
                    <div className={cx('budget-post')}>
                        ...
                        <div className={cx('right-post')}>
                            ...
                            <select className={cx('form-select', 'payment')} aria-label="Default select example">
                                <option selected><label className={cx('form-label')}>--Hình thức thanh toán--</label></option>
