...
export const getStatisticRecruiter = async (recruiterId) => {
    try {
        const res = await httpRequest.get(`api/recruiter/statistic?recruiterId=${recruiterId}`);
        return res;
    } catch (error) {
        console.log(error);
    }
};
export const getStatisticFreelancer = async (freelancerId) => {
    try {
        const res = await httpRequest.get(`api/freelancer/statistic?freelancerId=${freelancerId}`);
        return res;
    } catch (error) {
        console.log(error);
    }
